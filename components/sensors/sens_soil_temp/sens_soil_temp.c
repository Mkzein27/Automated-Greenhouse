...
// DS18B20 Commands
#define DS18B20_CMD_CONVERT_T       0x44    // Initiate temperature conversion
...
#define DS18B20_CMD_SKIP_ROM        0xCC    // Address all devices on bus
#define DS18B20_CMD_SEARCH_ROM      0xF0    // Search for devices
